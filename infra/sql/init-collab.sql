-- CotAI Collaboration Database Initialization Script
-- PostgreSQL 15.4
...
ALTER DATABASE cotai_collab SET search_path TO public, tenant_default;
...
COMMENT ON DATABASE cotai_collab IS 'CotAI Collaboration Database - Chat, Notifications, Agenda';
